...
class BudgetMain extends React.Component {
	...
	componentDidMount() {
		...
		this.props.getCurrentMonthGeneralInfo({isLoadingToken: this.isLoadingToken, currentMonth, currentYear});
		this.props.getMonthExpenseLimits({filters: currentMonthFilters});
	}
